...
const state = {
  elementsList: [{name: 'hydrogen', symbol: 'H', family: 'non-metal', location: '1', charge: 1, valence: 1, findex: 8},
    ...
    LewisIons: ['BF4-1', 'PF6-1', 'AsF6-1', 'SbF6-1','CO3-2', 'NO2-1', 'NO3-1', 'PO4-3', 'AsO4-3','SbO4-3', 'SO3-2', 'SO4-2',
...
const getters = {
  ...
  getLSEBad: (state) => state.lewisElementsBad,
  ...
  getLewisIons: (state) => state.LewisIons,
